      ...
      >
        <div className="max-w-5xl mx-auto px-5 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm">
            ...
            <Link href="/aboutfull" className={`${scrolled ? "text-gray-900 hover:text-gray-700" : "text-white hover:text-white/70"} transition-colors`}>About</Link>
            <Link href="/contactdetails" className={`${scrolled ? "text-gray-900 hover:text-gray-700" : "text-white hover:text-white/70"} transition-colors`}>Contact</Link>
          </div>
